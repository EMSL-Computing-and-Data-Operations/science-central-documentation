...
2. **Cross-Platform Navigation**: Seamless transition from Science Central to Teams
...
- **Thread Discussions**: Reply-in-thread functionality

### User Experience
- **Desktop Notifications**: Available for staying updated
- **Activity Tracking**: 7 new activities
...
- **Personal Accounts**: Integration with personal Microsoft accounts
...
For detailed information about Circles functionality, Teams integration, and access permissions, contact sc-collab-support@pnnl.gov